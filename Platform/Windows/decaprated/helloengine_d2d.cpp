...
inline void SafeRelease(T **ppInterfaceToRelease) {
    if (*ppInterfaceToRelease != nullptr) {
        ...
        // T make us confuse with what the ppInerfaceToRelease
                          // exactlly is, Yet we can still call its Release()
                          // function, even we don't know if this pointer
                          // contian this function,why is that?
