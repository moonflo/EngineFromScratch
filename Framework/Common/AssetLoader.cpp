...
My::AssetLoader::AssetFilePtr My::AssetLoader::OpenFile(const char* name,
                                                        AssetOpenMode mode) {
    FILE* fp = nullptr;
...
// relocate file pointer, make the fp change its position
int32_t My::AssetLoader::Seek(AssetFilePtr fp, long offset,
                              AssetSeekBase where) {
